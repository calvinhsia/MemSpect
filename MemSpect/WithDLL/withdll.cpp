...
#include <stdio.h>
#include <windows.h>
#include "..\VSAssert\Detours30\detours.h"
...
int CDECL main(int argc, char **argv)
{
	...
	BOOLEAN fGetExitCodeProcess = TRUE;
...
)
{
	...
	USES_CONVERSION;
	int cArgs = 0;
	LPWSTR * ptr = CommandLineToArgvW(cmdline, &cArgs);
	char **ptrA = (char **)_alloca(cArgs * sizeof(DWORD));
