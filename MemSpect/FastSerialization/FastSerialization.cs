...
using DeferedStreamLabel = FastSerialization0.StreamLabel;
using System.Diagnostics.Eventing;

// see code:#Introduction and code:#SerializerIntroduction
namespace FastSerialization0
{
    // #Introduction
    // 
    ...
    internal class SerializationType : IFastSerializable
    {
        ...
        void IFastSerializable.FromStream(Deserializer deserializer, int versionFromStream)
        {
    ...
    public class Deserializer : IDisposable
    {
        ...
        private IFastSerializable ReadObjectDefinition(Tags tag, StreamLabel objectLabel)
        {
            ...
            ret.FromStream(this, (type == null ? 0 : type.version));
            FindEndTag(type, ret);
    ...
    public interface IFastSerializable
    {
        ...
        /// </summary>
        void FromStream(Deserializer deserializer, int versionFromStream);
    }
