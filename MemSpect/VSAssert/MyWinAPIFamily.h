...
// To restrict the API surface to just the Metro API surface the 'app' family (WINAPI_FAMILY_APP.)
...
//
//      Example: Available to Metro and Desktop programs
...
//
//      Example: Available only to Metro programs
...
//
//      Example: Available to Metro, but not Desktop programs
