...
#define VcppException(sev,err)  ((sev<<30) | (FACILITY_VISUALCPP<<16) | err)
...
//#define EH_EXCEPTION_NUMBER	VcppException( 3, 0x7363 )		// SEV_ERROR, used by CRTs for C++

// used by debugger to do e.g. SetThreadName call
#define	EXCEPTION_VISUALCPP_DEBUGGER	VcppException(1, 5000)		// SEV_INFORMATIONAL
